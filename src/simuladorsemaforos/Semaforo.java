...
public class Semaforo extends ElementoSimulacao{
	private static int TEMPO_SEMAFORO = 15; //segundos
	...
	private Color luzAtual;
        private List<ListenerMudancaSemaforo> listeners = new CopyOnWriteArrayList<ListenerMudancaSemaforo>();
	...
	public int getTempoSemaforo() {
            return this.TEMPO_SEMAFORO;
        }

        public void setTempoSemaforo(int tempo) {
            int tempoAntigo = this.TEMPO_SEMAFORO;
            this.TEMPO_SEMAFORO = tempo;
            for(ListenerMudancaSemaforo listener : listeners){
                listener.tempoAlterado(this, tempoAntigo, tempo);
            }
        }
	...
	public void inicializar() {
        ...
        public void adicionarListenerMudancaSemaforo(ListenerMudancaSemaforo listener) {
            listeners.add(listener);
        }

        public void removerListenerMudancaSemaforo(ListenerMudancaSemaforo listener) {
