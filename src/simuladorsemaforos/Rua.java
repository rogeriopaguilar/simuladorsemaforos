...
public class Rua extends ElementoSimulacao implements ListenerMudancaSemaforo{
	...
	public Rua(Semaforo semaforo, Direcao direcao, ListenerRemocaoCarro listener) {
		...
		this.direcao = direcao;
                ...
                semaforo.setRua(this);
                semaforo.adicionarListenerMudancaSemaforo(this);
	}
